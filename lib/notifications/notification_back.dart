...
import 'package:road_mate/notifications/notification_helper.dart';
      ...
      await http.post(
        ...
        body: jsonEncode(<String, dynamic>{
          "message": {
            ...
            "notification": {
              "body":
                  'Your order is accepted. Service Provider will contact you soon and will arrive to your location',
